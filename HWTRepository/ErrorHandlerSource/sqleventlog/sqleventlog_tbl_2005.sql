/*----------------------------------------------------------------------
  The main table for SqlEventLog where all messages are logged. This version
  is for SQL 2005 only. There is a different version for SQL 2008 and later.
  ----------------------------------------------------------------------*/

CREATE TABLE slog.sqleventlog (
   logid     bigint         NOT NULL IDENTITY,
   logdate   datetime       NOT NULL  -- When message was logged.
      CONSTRAINT default_slog_logdate DEFAULT getdate(),
   ...
   logproc   nvarchar(256)  NULL,     -- In which procedure message was logged.
