...
***********************************************************************************************************************************
	...
	@p1					nvarchar(400)	input parameters for error message, translated to string
	@p2					nvarchar(400)   input parameters for error message, translated to string
	@p3					nvarchar(400)   input parameters for error message, translated to string
