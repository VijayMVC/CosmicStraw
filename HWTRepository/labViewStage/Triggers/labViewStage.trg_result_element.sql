...
--	Load repository equipment data from stage data
    EXECUTE hwt.usp_LoadRepositoryFromStage @pSourceTable = N'result_element' ;

--	MERGE trigger data into labViewStage.result_element table 
	 WITH	existing AS
			( 
			  SELECT	ID          
					  , VectorID    
				...
				FROM 	labViewStage.result_element AS a 
